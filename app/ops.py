...
def insert_customer(customer: models.Customer):
    ...
    return responses.response(True, "data inserted", data={"name": customer.name, "email": customer.email})
...
def update_customer(customer_id: int, customer: models.Customer):
    try:
        ...
        customer_data = {"name": customer.name, "email": customer.email, "stripe_customer_id": stripe_customer_id}
